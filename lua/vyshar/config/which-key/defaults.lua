return {
  ...
  f = { require('vyshar.config.utils').telescope_git_or_file, 'Find Files (Root)' },
  ...
  u = {
    name = 'UI',
    v = { require('vyshar.config.utils').toggle_set_color_column, 'Toggle Color Line' },
    c = { require('vyshar.config.utils').toggle_cursor_line, 'Toggle Cursor Line' },
  },
  i = {
    name = 'Sessions',
  ...
  l = {
    ...
    c = { require('vyshar.config.utils').copyFilePathAndLineNumber, 'Copy File Path and Line Number' },
